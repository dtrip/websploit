...
def update_websploit():
	...
	try:
		subprocess.Popen("cd /tmp;git clone https://github.com/dtrip/websploit.git;cp -R websploit/ /usr/share;rm -rf /tmp/websploit/", stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True).wait()
	except Exception, e:
